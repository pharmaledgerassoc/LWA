...
| app_version | Versión de app: | ok | 11 |
| leaflet_expired_message | &lt;p&gt; &lt;b&gt;Este producto ha sido identificado como caducado.&lt;/b&gt; &lt;/p&gt; | ok | 12 |
...
| disagree | En desacuerdo | ok | 26 |
| agree | De acuerdo | ok | 27 |
| disagree_extra_text | La aplicación "PharmaLedger" no funcionará hasta que acepte los términos y condiciones. Por favor, lea los términos y condiciones. | ok | 28 |
| fwd_privacy | Política de privacidad | ok | 29 |
| fwd_terms | Términos y condiciones | ok | 30 |
| fwd_help | Ayuda | ok | 31 |
| fwd_about | Acerca de | ok | 32 |
