...
| scan_again | Escaneie novamente | ok | 6 |
| product_not_found_title | Produto não encontrado | ok | 7 |
| product_not_found | Este produto não pode ser encontrado. | ok | 9 |
| leaflet_expired_title | Expirado / vencido | ok | 10 |
| app_version | Versão do aplicativo: | ok | 11 |
| leaflet_expired_message | &lt;p&gt; &lt;b&gt;Este produto foi identificado como expirado / vencido.&lt;/b&gt; &lt;/p&gt; | ok | 12 |
| select_lang_title | Idioma indisponível | ok | 13 |
...
| scan_error_title | Erro de varredura | ok | 18 |
| camera_error_message | Algo deu errado e a câmera selecionada não pode ser acessada corretamente. Verifique as configurações da câmera do dispositivo ou tente alterar a câmera no menu. | ok | 20 |
| leaflet_lang_select_message | O folheto não está disponível na sua língua preferida. Você pode escolher na lista de idiomas disponíveis. | ok | 21 |
| lang_proceed | Proceder | ok | 22 |
| go_home | Voltar para o início | ok | 24 |
| onboarding_welcome | Quase lá! Por favor, leia e concorde com os termos e condições de uso. | ok | 25 |
| disagree | Discordar | ok | 26 |
| agree | Concordar | ok | 27 |
| disagree_extra_text | O aplicativo "PharmaLedger" não funcionará até que você concorde com os termos e condições. Por favor, leia os termos e condições de uso. | ok | 28 |
| fwd_privacy | Política de privacidade | ok | 29 |
| fwd_terms | Termos e Condições | ok | 30 |
| fwd_help | Ajuda | ok | 31 |
| fwd_about | Sobre | ok | 32 |
| privacy_modal_subtitle | Nossos Princípios de Privacidade e Segurança | ok | 33 |
...
| country_va | Santa Sé (Estado da cidade do Vaticano) |  | 171 |
...
| country_ir | República Islâmica do Irã |  | 178 |
